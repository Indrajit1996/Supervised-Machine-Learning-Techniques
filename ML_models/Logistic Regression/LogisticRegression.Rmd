...
# Use the argument 'type = "response"' in the predict function to get a list of predictions between 0 and 1. It gives the predicted probabilities.
...
# The prediction object takes the probability scores and the original levels for this data as input
...
# Using the argument "Positive", we can get the evaluation metrics according to our positive reference level
